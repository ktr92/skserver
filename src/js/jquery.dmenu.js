;(function (root, factory) {
  ...
  !(function (e) {
    ...
    if (!(e[t] && e[t].version > s)) {
      ;(e[t] = function (e, t, s) {
        function i() {
          n._code("resize:start"),
            n._code("resize:before"),
            n._code("resize"),
            n._code("resize:after"),
            n._code("resize:finish")
        }
        var n = this
        ;(this.$menu = e),
          (this.opts = t),
        ...
        (e[t].prototype = {
          _code: function (s) {
            var i, n
            for (i in e[t].code)
              (n = e[t].code[i][s]), "function" == typeof n && n.call(this)
          },
        }),
        (e[t].code[t] = {
          setup: function () {
      ...
      !(function () {
        ;(o = {
          ...
          a.add("load resize mouseenter mouseleave"),
          (e[t]._c = i),
          (e[t]._d = n),
          (e[t]._e = a),
          (e[t]._g = o)
    ...
    (function (e) {
      ...
      ;(e[t].options[s] = {
        ...
        (e[t].configuration.classNames.selected = "Selected"),
      ...
      ;(e[t].prototype._itemsOverflow = function () {
        return (
          this.$menu.children("ul").height() >
          this.$items.not("." + i.hidden).outerHeight()
        )
      }),
        (e[t].code[s] = {
            ...
            if (this.$menu.is(":visible"))
              for (var s = 0; s < this.opts.item.fit.length; s++) {
                ...
                if (i && i.fit) {
                  ...
                  a.items && (n = n.filter(a.items)),
                    a.order || (a.order = i.order),
                    "rtl" == a.order && (n = e(n.get().reverse())),
                    i.fit.call(this, n, a)
                }
              }
          },
    ...
    (function (e) {
      ...
      ;(e[t].code[s] = {
        "setup:before": function () {
          this.vars.submenus =
            this.opts.submenu && this.$menu.find("ul ul").length
        },
        setup: function () {
        ...
        (e[t].fitters.submenu = {
          order: "rtl",
          reset: function (t) {
            this.$menu.find("." + i.item + "_" + s + "-overflow").remove(),
              t.each(function () {
              ...
              var a = this,
                ...
                u = e(
                  '<li class="' +
                    ...
                    "-overflow " +
                    i.item +
                    '_parent"><span>...</span></li>'
                )
              this.$menu.children("ul").append(u),
                (u = e("<ul />").appendTo(u)),
                t.each(function () {
                  if (o || a._itemsOverflow()) {
                    ...
                    for (
                      ...
                      n[d].slice(0, 3) == i.dm("") &&
                        ...
                        n[d] != i.item + "_parent" &&
                        t.removeClass(n[d])
                    "function" == typeof a["icon-hide"] && a["icon-hide"](t),
                      t
                        .find("li")
                        .removeClass(i.item + "_" + s + "-mega")
                        .removeClass(i.subitem + "_" + s + "-inline"),
                      u[r ? "append" : "prepend"](t)
                  }
                })
            }
          },
    ...
    (function (e) {
      ...
      e[t].code[s + "_" + i] = {
        "resize:after": function () {
          ;(this.opts.menu[i] && "left" != this.opts.menu[i]) ||
            this.$items
              .filter("." + n[s] + "_" + i + "-right")
              .css("margin-left", "")
              .not("." + n.hidden)
              .first()
    ...
    (function (e) {
      var t = "dmenu",
        s = "item",
        i = "icon"
      ;(e[t].configuration.classNames[s][i + "-hide"] = "IconHidden"),
        (e[t].configuration.classNames[s][i + "-only"] = "IconOnly")
      var n = e[t]._c,
        a = e[t]._d
      e[t]._e, e[t]._g
      ;(e[t].code[s + "_" + i] = {
        setup: function () {
          this.$items
            ...
            .each(function () {
              var t = e(this).parent(),
                a = t.parent()
              a.hasClass(n[s] + "_" + i + "-hide") ||
                a.hasClass(n[s] + "_" + i + "-only") ||
                a.hasClass(n[s] + "_" + i + "-text") ||
                a.addClass(
                  n[s] + "_" + i + "-" + (t.text().length ? "text" : "only")
                )
            })
        },
      }),
        (e[t].fitters[i + "-hide"] = {
          ...
          reset: function (e) {
            this[i + "-hide"](
              e.filter(
                "[data-" + a["class"] + '*="' + n[s] + "_" + i + '-hide"]'
              )
            ),
              this[i + "-only"](
                e.filter(
                  "[data-" + a["class"] + '*="' + n[s] + "_" + i + '-only"]'
                )
              ),
              this[i + "-text"](
                e.filter(
                  "[data-" + a["class"] + '*="' + n[s] + "_" + i + '-text"]'
                )
              )
          },
          fit: function (t, o) {
        ...
        (e[t].prototype[i + "-reset"] = function (e) {
          e.filter("[data-" + a["class"] + '*="' + n[s] + "_" + i + '-"]')
            .removeClass(n[s] + "_" + i + "-text")
            .removeClass(n[s] + "_" + i + "-only")
            .removeClass(n[s] + "_" + i + "-hide")
            .find("del")
            .contents()
            .unwrap()
        }),
        (e[t].prototype[i + "-hide"] = function (t) {
          this[i + "-reset"](t),
            t
              .filter("[data-" + a["class"] + '*="' + n[s] + "_" + i + '-"]')
              .addClass(n[s] + "_" + i + "-hide")
              .each(function () {
                var t = e(this).children("a, span")
                t.children(".fa, .fab, .fas, .far, .fal, [data-icon]").wrap(
                  '<del class="' + n.hidden + '" />'
                )
              })
        }),
        (e[t].prototype[i + "-only"] = function (t) {
          this[i + "-reset"](t),
            t
              .filter("[data-" + a["class"] + '*="' + n[s] + "_" + i + '-"]')
              .addClass(n[s] + "_" + i + "-only")
              .each(function () {
                var t = e(this).children("a, span")
                t.contents()
                  .not(t.children(".fa, .fab, .fas, .far, .fal, [data-icon]"))
                  .wrap('<del class="' + n.hidden + '" />')
              })
        }),
    ...
    (function (e) {
      ...
      e[t].code[s + "_" + i] = {
        setup: function () {
          this.opts[s][i] &&
            this.$menu.addClass(n[s] + "_" + i + "-" + this.opts[s][i])
        },
      }
    })(jQuery),
    (function (e) {
    ...
    (function (e) {
      ...
      e[t].code[s + "_" + i] = {
        setup: function () {
          this.vars.submenus &&
            this.opts[s][i] &&
            this.$menu.addClass(n.menu + "_" + s + "-" + i)
        },
      }
    })(jQuery),
    (function (e) {
    ...
    (function (e) {
      var t = "dmenu",
        s = "submenu",
        i = "align"
      ;(e[t].configuration.classNames.item[s + "-" + i + "-right"] =
        "SubmenuAlignRight"),
        (e[t].configuration.classNames.subitem[s + "-" + i + "-right"] =
          "SubSubmenuAlignRight")
      var n = e[t]._c,
        a = e[t]._d,
        o = e[t]._e,
        r = e[t]._g
          ...
          setup: function () {
            ...
            !(function () {
              ...
              t.$menu.on(
                ...
                function (s) {
                  ...
                  if (!i.hasClass(u)) {
                    var a = !1
                    i.hasClass(r)
                      ? t._submenuOverflowsLeft(n) &&
                        (i.removeClass(r), (a = !0))
                      : t._submenuOverflowsRight(n) &&
                        (i.addClass(r), (a = !0)),
                      a &&
                        (t._submenuOverflowsLeft(n) ||
                          t._submenuOverflowsRight(n)) &&
              ...
              (function () {
                ...
                t.$menu.on(
                  o.mouseenter,
                  " li li." + n.item + "_parent",
                  function (s) {
                    var i = e(this),
                      n = i.children("ul")
                    i.hasClass(r)
                      ? t._submenuOverflowsLeft(n) && i.removeClass(r)
                      : t._submenuOverflowsRight(n) && i.addClass(r)
                  }
                ),
                  t.$menu.on(
                    o.mouseleave,
    ...
    (function (e) {
      ...
      e[t].code[s + "_" + i] = {
        ...
        "setup:after": function () {
          this.vars.submenus &&
            this.$menu.hasClass(n.menu + "_item-border") &&
            this.$menu.removeClass(n.menu + "_" + s + "-" + i)
        },
      }
    })(jQuery),
    (function (e) {
      ...
      ;(e[t].code[s + "_" + i] = {
            ...
            t.$menu.on(
              ...
              function (a) {
                var o = e(this)
                  .children("ul")
                  .children("." + n.selected)
                o.length || (o = e(this).children("ul").children("li").first()),
                  t[s + "-" + i + "-set"](o)
              }
            ),
              t.$menu.on(
        ...
        (e[t].prototype[s + "-" + i + "-reset"] = function (e) {
          e.children("ul")
            ...
            .filter("[data-" + a["class"] + '*="' + n.selected + '"]')
            .addClass(n.selected)
        }),
        (e[t].prototype[s + "-" + i + "-set"] = function (e) {
          var t = e.parent("ul"),
            s = e.children("ul")
          t.children("li").removeClass(n.selected),
